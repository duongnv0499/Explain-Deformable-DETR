...
class DeformableDETR(nn.Module):
    print('run class DeformableDETR')
...
class SetCriterion(nn.Module):
    ...
    def forward(self, outputs, targets):
        print('run forward to loss computation')
